                ...
                <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical ">
                    <li>
                        ...
                        <div   data-aos="fade-right" data-aos-duration="1000" className="timeline-start md:text-end mb-10 space-y-2.5 max-w-[450px] ">
                            ...
                            <p className="text-[#B1B1A2]">Now I am studying on Chattogram Polytechnic Institute. I am a student of Electronics Department</p>
                    ...
                    <li>
                        ...
                        <time className="font-mono italic text-[#B1B1A2]">2019-2020</time>
                            ...
                            <p className="text-[#B1B1A2]">I completed my SSC examination, In 2020, At the school of Chattogram which is the renowned school of Chattogram that is Halishahar Alhaj Mohobbat Ali City Corporation High School.</p>
                        </div>
                        <hr />
                    </li>
                </ul>
                ...
                <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical lg:pb-16 md:pb-12 pb-6">
                    <li>
                        ...
                        <div data-aos="fade-right" data-aos-duration="1000" className="timeline-start md:text-end mb-10 space-y-2.5 max-w-[450px]">
                            ...
                            <p className="text-[#B1B1A2]">I completed my full Stack Web Development Course from Programming Hero.</p>
