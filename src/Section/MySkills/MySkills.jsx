  ...
  return (
    <section id="skill" className=" bg-[#111]">
      <Title
        first={"My"}
        last={"Skills"}
        description={"Let’s Explore Popular Skills & Experience"}></Title>
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 py-20">
          {skills.map((skill) => (
            <div
              key={skill.skillName}
              className="card  overflow-hidden hover:scale-105 transition-all duration-200 ease-in-out border-[#C9F31D] h-[300px] card-compact bg-[#1F1F1F] shadow-xl relative
                    ">
